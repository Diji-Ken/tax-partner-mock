                    ...
                    >
                      ...
                      {integ.connected && integ.connectedClients > 0 && (
                        <div className="mt-2 pt-2 border-t border-slate-50 text-xs text-slate-400">
                          {integ.connectedClients}{'\u793E\u306E\u9867\u554F\u5148\u3067\u5229\u7528\u4E2D'}
                        </div>
                      )}
                    </div>
                  ))}
              ...
              {staff.map((s) => (
                <tr key={s.id} className="border-b border-slate-50 hover:bg-slate-50">
                  ...
                  <td className="py-3 px-4">
                    <span className={`text-[10px] font-medium px-2 py-0.5 rounded ${roleColors[s.role]}`}>{s.role}</span>
                  </td>
                  <td className="py-3 px-4">
                  ...
                  <td className="py-3 px-4">
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${productivityColors[s.productivity]}`}>{s.productivity}</span>
                  </td>
                </tr>
              ))}
            </tbody>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" defaultValue={'\u30B5\u30F3\u30D7\u30EB\u4F1A\u8A08\u4E8B\u52D9\u6240'} className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ea580c]/30" />
              </div>
              <div>
                <label className="text-xs text-slate-500 block mb-1">{'\u4EE3\u8868\u8005'}</label>
                <input type="text" defaultValue={'\u5C71\u7530\u592A\u90CE'} className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ea580c]/30" />
              </div>
              <div>
                <label className="text-xs text-slate-500 block mb-1">{'\u96FB\u8A71\u756A\u53F7'}</label>
                <input type="text" defaultValue="048-xxx-xxxx" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ea580c]/30" />
              </div>
              <div>
                <label className="text-xs text-slate-500 block mb-1">{'\u30E1\u30FC\u30EB'}</label>
                <input type="text" defaultValue="info@sample-tax.co.jp" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ea580c]/30" />
              </div>
            </div>
          </div>
